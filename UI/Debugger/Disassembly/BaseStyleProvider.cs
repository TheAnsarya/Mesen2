...
namespace Mesen.Debugger.Disassembly {
	public class BaseStyleProvider : ILineStyleProvider {
		...
		private void ConfigureActiveStatement(LineProperties props) {
			...
			props.TextBgColor = features.ChangeProgramCounter
				? Color.FromUInt32(ConfigManager.Config.Debug.Debugger.CodeActiveStatementColor)
				: Color.FromUInt32(ConfigManager.Config.Debug.Debugger.CodeActiveMidInstructionColor);
