...
public:
	...
	XM_ALIGNED_STRUCT(16)
	SpriteInfo : public AlignedNew<SpriteInfo> {
		XMFLOAT4A source;
...
_Use_decl_annotations_ void XM_CALLCONV SpriteBatch::Impl::Begin(SpriteSortMode sortMode,
...
_Use_decl_annotations_ void SpriteBatch::Impl::RenderBatch(ID3D11ShaderResourceView* texture, SpriteInfo const* const* sprites, size_t count) {
	auto deviceContext = mContextResources->deviceContext.Get();
...
_Use_decl_annotations_ void XM_CALLCONV SpriteBatch::Begin(SpriteSortMode sortMode, bool useBilinearInterpolation) {
	pImpl->Begin(sortMode, useBilinearInterpolation);
}

_Use_decl_annotations_ void XM_CALLCONV SpriteBatch::Begin(SpriteSortMode sortMode,
                                                           ID3D11BlendState* blendState,
                                                           ID3D11SamplerState* samplerState,
                                                           ID3D11DepthStencilState* depthStencilState,
                                                           ID3D11RasterizerState* rasterizerState,
...
_Use_decl_annotations_ void XM_CALLCONV SpriteBatch::Draw(ID3D11ShaderResourceView* texture, XMFLOAT2 const& position, FXMVECTOR color) {
...
_Use_decl_annotations_ void XM_CALLCONV SpriteBatch::Draw(ID3D11ShaderResourceView* texture, FXMVECTOR position, FXMVECTOR color) {
...
_Use_decl_annotations_ void XM_CALLCONV SpriteBatch::Draw(ID3D11ShaderResourceView* texture, RECT const& destinationRectangle, FXMVECTOR color) {
