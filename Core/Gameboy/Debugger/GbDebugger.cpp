...
void GbDebugger::Step(int32_t stepCount, StepType type) {
	...
	switch (type) {
		...
		case StepType::PpuScanline:
			step.PpuStepCount = 456 * stepCount;
			break;
		case StepType::PpuFrame:
			step.PpuStepCount = 456 * 154 * stepCount;
			break;
...
bool GbDebugger::SaveRomToDisk(const string& filename, bool saveAsIps, CdlStripOption stripOption) {
