...
void GbaTraceLogger::GetTraceRow(string& output, GbaCpuState& cpuState, TraceLogPpuState& ppuState, DisassemblyInfo& disassemblyInfo) {
	for (RowPart& rowPart : _rowParts) {
		switch (rowPart.DataType) {
			case RowDataType::R0:
				WriteIntValue(output, cpuState.R[0], rowPart);
				break;
			case RowDataType::R1:
				WriteIntValue(output, cpuState.R[1], rowPart);
				break;
			case RowDataType::R2:
				WriteIntValue(output, cpuState.R[2], rowPart);
				break;
			case RowDataType::R3:
				WriteIntValue(output, cpuState.R[3], rowPart);
				break;
			case RowDataType::R4:
				WriteIntValue(output, cpuState.R[4], rowPart);
				break;
			case RowDataType::R5:
				WriteIntValue(output, cpuState.R[5], rowPart);
				break;
			case RowDataType::R6:
				WriteIntValue(output, cpuState.R[6], rowPart);
				break;
			case RowDataType::R7:
				WriteIntValue(output, cpuState.R[7], rowPart);
				break;
			case RowDataType::R8:
				WriteIntValue(output, cpuState.R[8], rowPart);
				break;
			case RowDataType::R9:
				WriteIntValue(output, cpuState.R[9], rowPart);
				break;
			case RowDataType::R10:
				WriteIntValue(output, cpuState.R[10], rowPart);
				break;
			case RowDataType::R11:
				WriteIntValue(output, cpuState.R[11], rowPart);
				break;
			case RowDataType::R12:
				WriteIntValue(output, cpuState.R[12], rowPart);
				break;
			case RowDataType::R13:
				WriteIntValue(output, cpuState.R[13], rowPart);
				break;
			case RowDataType::R14:
				WriteIntValue(output, cpuState.R[14], rowPart);
				break;
			case RowDataType::R15:
				WriteIntValue(output, cpuState.R[15], rowPart);
				break;
			...
			case RowDataType::Mode: {
				switch (cpuState.CPSR.Mode) {
					case GbaCpuMode::User:
						WriteStringValue(output, "USR", rowPart);
						break;
					case GbaCpuMode::Fiq:
						WriteStringValue(output, "FIQ", rowPart);
						break;
					case GbaCpuMode::Irq:
						WriteStringValue(output, "IRQ", rowPart);
						break;
					case GbaCpuMode::Supervisor:
						WriteStringValue(output, "SVC", rowPart);
						break;
					case GbaCpuMode::Abort:
						WriteStringValue(output, "ABT", rowPart);
						break;
					case GbaCpuMode::Undefined:
						WriteStringValue(output, "UND", rowPart);
						break;
					case GbaCpuMode::System:
						WriteStringValue(output, "SYS", rowPart);
						break;
				}
				break;
			}
