		...
		case DebugEventType::Register:
			...
			switch (addr >> 24) {
				case 4:
					...
					break;
				case 5:
					return isWrite ? _config.PaletteWrites : _config.PaletteReads;
				case 6:
					return isWrite ? _config.VramWrites : _config.VramReads;
				case 7:
					return isWrite ? _config.OamWrites : _config.OamReads;
				default:
					return {};
			}
	}
