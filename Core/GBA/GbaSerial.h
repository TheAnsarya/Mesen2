...
public:
	...
	uint8_t ReadRegister(uint32_t addr, bool peek) {
		...
		switch (addr) {
			...
			case 0x129:
				return BitUtilities::GetBits<8>(_state.Control);

			case 0x12A:
				return BitUtilities::GetBits<0>(_state.SendData);
			case 0x12B:
				return BitUtilities::GetBits<8>(_state.SendData);

			case 0x134:
				return BitUtilities::GetBits<0>(_state.Mode);
			case 0x135:
				return BitUtilities::GetBits<8>(_state.Mode);
			case 0x136:
				return 0;
			case 0x137:
				return 0;
			...
			case 0x140:
				return BitUtilities::GetBits<0>(_state.JoyControl);
			case 0x141:
				return BitUtilities::GetBits<8>(_state.JoyControl);
			case 0x142:
				return 0;
			case 0x143:
				return 0;
			...
			case 0x150:
				return BitUtilities::GetBits<0>(_state.JoyReceive);
			case 0x151:
				return BitUtilities::GetBits<8>(_state.JoyReceive);
			case 0x152:
				return BitUtilities::GetBits<16>(_state.JoyReceive);
			case 0x153:
				return BitUtilities::GetBits<24>(_state.JoyReceive);

			case 0x154:
				return BitUtilities::GetBits<0>(_state.JoySend);
			case 0x155:
				return BitUtilities::GetBits<8>(_state.JoySend);
			case 0x156:
				return BitUtilities::GetBits<16>(_state.JoySend);
			case 0x157:
				return BitUtilities::GetBits<24>(_state.JoySend);

			case 0x158:
				return _state.JoyStatus;
		}
	...
	void WriteRegister(uint32_t addr, uint8_t value) {
		...
		switch (addr) {
			...
			case 0x12A:
				BitUtilities::SetBits<0>(_state.SendData, value);
				break;
			case 0x12B:
				BitUtilities::SetBits<8>(_state.SendData, value);
				break;
			...
			case 0x140:
				BitUtilities::SetBits<0>(_state.JoyControl, value);
				break;
			case 0x141:
				BitUtilities::SetBits<8>(_state.JoyControl, value);
				break;

			case 0x150:
				BitUtilities::SetBits<0>(_state.JoyReceive, value);
				break;
			case 0x151:
				BitUtilities::SetBits<8>(_state.JoyReceive, value);
				break;
			case 0x152:
				BitUtilities::SetBits<16>(_state.JoyReceive, value);
				break;
			case 0x153:
				BitUtilities::SetBits<24>(_state.JoyReceive, value);
				break;

			case 0x154:
				BitUtilities::SetBits<0>(_state.JoySend, value);
				break;
			case 0x155:
				BitUtilities::SetBits<8>(_state.JoySend, value);
				break;
			case 0x156:
				BitUtilities::SetBits<16>(_state.JoySend, value);
				break;
			case 0x157:
				BitUtilities::SetBits<24>(_state.JoySend, value);
				break;

			case 0x158:
				_state.JoyStatus = value;
				break;
		}
	}
