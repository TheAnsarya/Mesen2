...
uint8_t WsTimer::ReadPort(uint16_t port) {
	switch (port) {
		...
		case 0xA4:
			return BitUtilities::GetBits<0>(_state.HReloadValue);
			break;
		case 0xA5:
			return BitUtilities::GetBits<8>(_state.HReloadValue);
			break;
		case 0xA6:
			return BitUtilities::GetBits<0>(_state.VReloadValue);
			break;
		case 0xA7:
			return BitUtilities::GetBits<8>(_state.VReloadValue);
			break;
		case 0xA8:
			return BitUtilities::GetBits<0>(_state.HTimer);
			break;
		case 0xA9:
			return BitUtilities::GetBits<8>(_state.HTimer);
			break;
		case 0xAA:
			return BitUtilities::GetBits<0>(_state.VTimer);
			break;
		case 0xAB:
			return BitUtilities::GetBits<8>(_state.VTimer);
			break;
	}
