...
private:
	...
	[[nodiscard]] static bool IsPrefix(uint8_t opCode);
...
public:
	...
	[[nodiscard]] static bool IsJumpToSub(uint16_t opCode);
	[[nodiscard]] static bool IsReturnInstruction(uint16_t opCode);
	[[nodiscard]] static bool IsUnconditionalJump(uint16_t opCode);
	[[nodiscard]] static bool IsConditionalJump(uint16_t opCode);

	[[nodiscard]] static bool IsUndefinedOpCode(uint16_t opCode);
	[[nodiscard]] static bool IsPushPopInstruction(uint16_t opCode);
