...
void Spc::Addr_DirToDir() {
	if (_opStep == SpcOpStep::Addressing) {
		switch (_opSubStep++) {
			case 0:
				_tmp1 = GetDirectAddress(ReadOperandByte());
				break;
			case 1:
				_operandA = Read(_tmp1);
				break;
			case 2:
...
void Spc::Addr_DirIdxXInd() {
	if (_opStep == SpcOpStep::Addressing) {
		switch (_opSubStep++) {
			case 0:
				_tmp1 = GetDirectAddress(ReadOperandByte() + _state.X);
				break;
			case 1:
				Idle();
				break;
...
void Spc::AND() {
	if (_opStep == SpcOpStep::Operation) {
		switch (_opSubStep++) {
			case 0:
				_tmp1 = _operandA & Read(_operandB);
				break;
			case 1:
...
void Spc::ASL() {
	if (_opStep == SpcOpStep::Operation) {
		switch (_opSubStep++) {
			case 0:
				_tmp1 = ShiftLeft(Read(_operandA));
				break;
			case 1:
				Write(_operandA, (uint8_t)_tmp1);
				EndOp();
...
void Spc::LSR() {
	if (_opStep == SpcOpStep::Operation) {
		switch (_opSubStep++) {
			case 0:
				_tmp1 = ShiftRight(Read(_operandA));
				break;
			case 1:
				Write(_operandA, (uint8_t)_tmp1);
				EndOp();
...
void Spc::ROR() {
	if (_opStep == SpcOpStep::Operation) {
		switch (_opSubStep++) {
			case 0:
				_tmp1 = RollRight(Read(_operandA));
				break;
			case 1:
				Write(_operandA, (uint8_t)_tmp1);
				EndOp();
