...
void Cx4::Exec(uint16_t opCode) {
	...
	switch (op) {
		...
		case 0x04:
			...
			break; //???
		case 0x08:
			Branch(true, param1, param2);
			break;
		case 0x0C:
			Branch(_state.Zero, param1, param2);
			break;

		case 0x10:
			Branch(_state.Carry, param1, param2);
			break;
		case 0x14:
			Branch(_state.Negative, param1, param2);
			break;
		case 0x18:
			Branch(_state.Overflow, param1, param2);
			break;
		case 0x1C:
			WAIT();
			break;
		...
		case 0x24:
			...
			break;
		case 0x28:
			JSR(true, param1, param2);
			break;
		case 0x2C:
			JSR(_state.Zero, param1, param2);
			break;

		case 0x30:
			JSR(_state.Carry, param1, param2);
			break;
		case 0x34:
			JSR(_state.Negative, param1, param2);
			break;
		case 0x38:
			JSR(_state.Overflow, param1, param2);
			break;
		case 0x3C:
			RTS();
			break;
		...
		case 0x60:
			...
			break;
		case 0x64:
			Load_Imm(param1, param2);
			break;
		case 0x68:
			ReadRam(param1);
			break;
		case 0x6C:
			ReadRam_Imm(param1, param2);
			break;
		...
		case 0x80:
			...
			break;
		case 0x84:
			ADD_Imm(param1, param2);
			break;
		case 0x88:
			SUBR(param1, param2);
			break;
		case 0x8C:
			SUBR_Imm(param1, param2);
			break;
		...
		case 0xA0:
			...
			break;
		case 0xA4:
			XNOR_Imm(param1, param2);
			break;
		case 0xA8:
			XOR(param1, param2);
			break;
		case 0xAC:
			XOR_Imm(param1, param2);
			break;
		...
		case 0xB0:
			...
			break;
		case 0xB4:
			AND_Imm(param1, param2);
			break;
		case 0xB8:
			OR(param1, param2);
			break;
		case 0xBC:
			OR_Imm(param1, param2);
			break;
...
uint32_t Cx4::GetSourceValue(uint8_t src) {
	switch (src & 0x7F) {
		case 0x00:
			return _state.A;
		case 0x01:
			return (_state.Mult >> 24) & 0xFFFFFF;
		case 0x02:
			return _state.Mult & 0xFFFFFF;
		case 0x03:
			return _state.MemoryDataReg;
		case 0x08:
			return _state.RomBuffer;
		case 0x0C:
			return (_state.RamBuffer[2] << 16) | (_state.RamBuffer[1] << 8) | _state.RamBuffer[0];
		case 0x13:
			return _state.MemoryAddressReg;
		case 0x1C:
			return _state.DataPointerReg;
		case 0x20:
			return _state.PC;
		case 0x28:
			return _state.P;
		...
		case 0x60:
		case 0x70:
			return _state.Regs[0];
		case 0x61:
		case 0x71:
			return _state.Regs[1];
		case 0x62:
		case 0x72:
			return _state.Regs[2];
		case 0x63:
		case 0x73:
			return _state.Regs[3];
		case 0x64:
		case 0x74:
			return _state.Regs[4];
		case 0x65:
		case 0x75:
			return _state.Regs[5];
		case 0x66:
		case 0x76:
			return _state.Regs[6];
		case 0x67:
		case 0x77:
			return _state.Regs[7];
		case 0x68:
		case 0x78:
			return _state.Regs[8];
		case 0x69:
		case 0x79:
			return _state.Regs[9];
		case 0x6A:
		case 0x7A:
			return _state.Regs[10];
		case 0x6B:
		case 0x7B:
			return _state.Regs[11];
		case 0x6C:
		case 0x7C:
			return _state.Regs[12];
		case 0x6D:
		case 0x7D:
			return _state.Regs[13];
		case 0x6E:
		case 0x7E:
			return _state.Regs[14];
		case 0x6F:
		case 0x7F:
			return _state.Regs[15];
	}
...
void Cx4::WriteRegister(uint8_t reg, uint32_t value) {
	...
	switch (reg & 0x7F) {
		case 0x01:
			_state.Mult = (_state.Mult & 0xFFFFFF) | ((uint64_t)value << 24);
			break;
		case 0x02:
			_state.Mult = (_state.Mult & 0xFFFFFF000000) | value;
			break;
		case 0x03:
			_state.MemoryDataReg = value;
			break;
		case 0x08:
			_state.RomBuffer = value;
			break;
		case 0x0C:
		...
		case 0x13:
			_state.MemoryAddressReg = value;
			break;
		case 0x1C:
			_state.DataPointerReg = value;
			break;
		case 0x20:
			_state.PC = value;
			break;
		case 0x28:
			_state.P = (value & 0x7FFF);
			break;
		...
		case 0x6A:
		case 0x7A:
			_state.Regs[10] = value;
			break;
		case 0x6B:
		case 0x7B:
			_state.Regs[11] = value;
			break;
		case 0x6C:
		case 0x7C:
			_state.Regs[12] = value;
			break;
		case 0x6D:
		case 0x7D:
			_state.Regs[13] = value;
			break;
		case 0x6E:
		case 0x7E:
			_state.Regs[14] = value;
			break;
		case 0x6F:
		case 0x7F:
			_state.Regs[15] = value;
			break;
	}
}
...
void Cx4::Skip(uint8_t flagToCheck, uint8_t skipIfSet) {
	...
	switch (flagToCheck) {
		default:
		case 0:
			skip = _state.Overflow == (skipIfSet & 0x01);
			break;
		case 1:
			skip = _state.Carry == (skipIfSet & 0x01);
			break;
		case 2:
			skip = _state.Zero == (skipIfSet & 0x01);
			break;
		case 3:
			skip = _state.Negative == (skipIfSet & 0x01);
			break;
	}
...
void Cx4::Load(uint8_t dest, uint8_t src) {
	switch (dest) {
		case 0:
			_state.A = GetSourceValue(src);
			break;
		case 1:
			_state.MemoryDataReg = GetSourceValue(src);
			break;
		case 2:
			_state.MemoryAddressReg = GetSourceValue(src);
			break;
		case 3:
			_state.P = GetSourceValue(src) & 0x7FFF;
			break;
	}
}
...
void Cx4::Load_Imm(uint8_t dest, uint8_t imm) {
	switch (dest) {
		case 0:
			...
			break;
		case 1:
			_state.MemoryDataReg = imm;
			break;
		case 2:
			_state.MemoryAddressReg = imm;
			break;
		case 3:
			_state.P = imm;
			break;
...
void Cx4::LoadP(uint8_t byteIndex, uint8_t imm) {
	switch (byteIndex) {
		case 0:
			_state.P = (_state.P & 0x7F00) | imm;
			break;
		case 1:
			_state.P = (_state.P & 0xFF) | ((imm & 0x7F) << 8);
			break;
		default:
			break; // nop
	}
...
void Cx4::Store(uint8_t src, uint8_t dst) {
	switch (src) {
		case 0:
			WriteRegister(dst, _state.A);
			break;
		case 1:
			WriteRegister(dst, _state.MemoryDataReg);
			break;
		default:
			break; // nop
	}
