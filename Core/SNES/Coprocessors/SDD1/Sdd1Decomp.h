...
class SDD1_IM : public ISerializable { // Input Manager
	Sdd1Mmc* _sdd1Mmc;
...
class SDD1_BG : public ISerializable { // Bits Generator
...
class SDD1_PEM : public ISerializable { // Probability Estimation Module
...
class SDD1_CM : public ISerializable { // Context Model
...
class SDD1_OL : public ISerializable { // Output Logic
