	...
	if (op.OperandCount == 3) {
		...
		if (operand2.Type == OperandType::X) {
			switch (operand.ByteCount) {
				case 1:
					AdjustOperandSize(op, operand, SnesAddrMode::DirIdxX, SnesAddrMode::AbsIdxX);
					break;
				case 2:
					op.AddrMode = SnesAddrMode::AbsIdxX;
					break;
				case 3:
					op.AddrMode = SnesAddrMode::AbsLngIdxX;
					break;
				default:
					return AssemblerSpecialCodes::ParsingError;
			}
			...
			switch (operand.ByteCount) {
				case 1:
					AdjustOperandSize(op, operand, SnesAddrMode::DirIdxY, SnesAddrMode::AbsIdxY);
					break;
				case 2:
					op.AddrMode = SnesAddrMode::AbsIdxY;
					break;
				default:
					return AssemblerSpecialCodes::ParsingError;
			}
