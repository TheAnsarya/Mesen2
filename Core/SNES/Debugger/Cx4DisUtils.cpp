...
void Cx4DisUtils::GetDisassembly(DisassemblyInfo& info, string& out, uint32_t memoryAddr, LabelManager* labelManager, EmuSettings* settings) {
	...
	switch (op) {
		...
		case 0x48:
			...
			break;
		case 0x4C:
			str.WriteAll("CMPR #$", HexUtilities::ToHex(param2));
			str.Write(",");
			writeShiftedA();
			break;
		...
		case 0x68:
			str.WriteAll("RDRAM RAM:", '0' + param1, ",A");
			break;
		case 0x6C:
			str.WriteAll("RDRAM RAM:", '0' + param1, ",DPR+#$", HexUtilities::ToHex(param2));
			break;
		...
		case 0x70:
			...
			break;
		case 0x74:
			str.WriteAll("RDROM (#$", HexUtilities::ToHex((param1 << 8) | param2), ")");
			break;
		case 0x78:
			str.Write("???");
			break;
		...
		case 0x88:
			...
			break;
		case 0x8C:
			str.WriteAll("SUBR #$", HexUtilities::ToHex(param2));
			str.Write(",");
			writeShiftedA();
			break;
		...
		case 0x98:
			...
			break;
		case 0x9C:
			str.WriteAll("SMUL A,#$", HexUtilities::ToHex(param2));
			break;
		...
		case 0xC0:
			...
			break;
		case 0xC4:
			str.WriteAll("SHR A,#$", HexUtilities::ToHex(param2 & 0x1F));
			break;
		case 0xC8:
			str.Write("ASR A,");
			writeSrc();
			break;
		case 0xCC:
			str.WriteAll("ASR A,#$", HexUtilities::ToHex(param2 & 0x1F));
			break;
		...
		case 0xD0:
			...
			break;
		case 0xD4:
			str.WriteAll("ROR A,#$", HexUtilities::ToHex(param2 & 0x1F));
			break;
		case 0xD8:
			str.Write("SHL A,");
			writeSrc();
			break;
		case 0xDC:
			str.WriteAll("SHL A,#$", HexUtilities::ToHex(param2 & 0x1F));
			break;
		...
		case 0xE4:
			...
			break;
		case 0xE8:
			str.WriteAll("WRRAM A,RAM:", '0' + param1);
			break;
		case 0xEC:
			str.WriteAll("WRRAM DPR+#$", HexUtilities::ToHex(param2), ",RAM:", '0' + param1);
			break;

		case 0xF0:
			str.WriteAll("SWAP A,R", std::to_string(param2 & 0x0F));
			break;
		case 0xF4:
			str.Write("???");
			break;
