...
protected:
	...
	void UpdateState() {
		...
		SelectPrgPage2x(0, ((_regs[0] & 0x10) ? (r | (_regs[1] & 0x07)) + (_epromFirst ? 0x02 : 0x00) : _epromFirst ? 0x00
		                                                                                                            : 0x80)
		                       << 1);
		SelectPrgPage2x(1, ((_regs[0] & 0x10) ? (r | (0xFF & 0x07)) + (_epromFirst ? 0x02 : 0x00) : _epromFirst ? 0x01
		                                                                                                        : 0x81)
		                       << 1);
