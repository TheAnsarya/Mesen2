...
protected:
	...
	void WriteRegister(uint16_t addr, uint8_t value) override {
		if (addr >= 0xA008) {
			...
			switch (addr & 0xF00E) {
				case 0xA008:
					UpdateChrReg(0, value, low);
					break;
				case 0xA00A:
					UpdateChrReg(1, value, low);
					break;
				case 0xC000:
					UpdateChrReg(2, value, low);
					break;
				case 0xC002:
					UpdateChrReg(3, value, low);
					break;
				case 0xC008:
					UpdateChrReg(4, value, low);
					break;
				case 0xC00A:
					UpdateChrReg(5, value, low);
					break;
				case 0xE000:
					UpdateChrReg(6, value, low);
					break;
				case 0xE002:
					UpdateChrReg(7, value, low);
					break;
			}
		} else {
			switch (addr & 0xF00F) {
				case 0x8000:
					SelectPrgPage(0, ((value & 0x02) << 2) | ((value & 0x08) >> 2) | (value & 0x05));
				...
				case 0x8008:
					...
					break;
				case 0xA000:
					SelectPrgPage(1, ((value & 0x02) << 2) | ((value & 0x08) >> 2) | (value & 0x05));
					break;
			}
		}
	}
