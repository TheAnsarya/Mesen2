...
protected:
	...
	void WriteRegister(uint16_t addr, uint8_t value) override {
		...
		switch (addr & 0xF002) {
			...
			case 0xB000:
				UpdatePrgReg(0, value, low);
				break;
			case 0xB002:
				UpdatePrgReg(1, value, low);
				break;
			case 0xC000:
				UpdatePrgReg(2, value, low);
				break;
			case 0xC002:
				UpdatePrgReg(3, value, low);
				break;
			case 0xD000:
				UpdatePrgReg(4, value, low);
				break;
			case 0xD002:
				UpdatePrgReg(5, value, low);
				break;
			case 0xE000:
				UpdatePrgReg(6, value, low);
				break;
			case 0xE002:
				UpdatePrgReg(7, value, low);
				break;
		}
	}
};