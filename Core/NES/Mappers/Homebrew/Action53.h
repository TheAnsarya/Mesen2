...
protected:
	...
	void UpdateState() {
		...
		if (prgSize) {
			...
			switch (gameSize) {
				case 0:
					SelectPrgPage(bank, (outerPrgSelect & 0x1FE) | (prgSelect & 0x01));
					break;
				case 1:
					SelectPrgPage(bank, (outerPrgSelect & 0x1FC) | (prgSelect & 0x03));
					break;
				case 2:
					SelectPrgPage(bank, (outerPrgSelect & 0x1F8) | (prgSelect & 0x07));
					break;
				case 3:
					SelectPrgPage(bank, (outerPrgSelect & 0x1F0) | (prgSelect & 0x0F));
					break;
			}
