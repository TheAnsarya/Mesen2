...
public:
	FlashS29(uint8_t* data, uint32_t size) {
		...
		switch (_size) {
			case 0x100000:
				_model = ChipModel::S29AL008;
				break;
			case 0x200000:
				_model = ChipModel::S29AL016;
				break;
			case 0x400000:
				_model = ChipModel::S29JL032;
				break;
			case 0x800000:
				_model = ChipModel::S29GL064S;
				break;
		}
	}
	...
	int16_t Read(uint32_t addr) {
		if (_softwareId) {
			switch (addr & 0x1FF) {
				...
				case 0x02: {
					switch (_model) {
						case ChipModel::S29AL008:
							return 0x5B;
						case ChipModel::S29AL016:
							return 0x49;
						case ChipModel::S29JL032:
							return 0x7E;
						case ChipModel::S29GL064S:
							return 0x7E;
						default:
							return 0xFF;
					}
			...
			if (_cycle == 3) {
				...
				if (cmd == 0xAAA && value == 0x10) {
					...
					if (page == pageCount - 1) {
						...
						switch (_model) {
							case ChipModel::S29AL008:
								sectorSizes = vector<int>{32, 8, 8, 16};
								break;
							case ChipModel::S29AL016:
								sectorSizes = vector<int>{32, 8, 8, 16};
								break;
							case ChipModel::S29JL032:
								sectorSizes = vector<int>{8, 8, 8, 8, 8, 8, 8, 8};
								break;
							case ChipModel::S29GL064S:
								sectorSizes = vector<int>{8, 8, 8, 8, 8, 8, 8, 8};
								break;
