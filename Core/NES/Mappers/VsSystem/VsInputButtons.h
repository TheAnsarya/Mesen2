...
private:
	...
	void ProcessInsertCoin(uint8_t port) {
		if (_needInsertCoin[port] > 0) {
			...
			switch (port) {
				case 0:
					SetBit(VsInputButtons::VsButtons::InsertCoin1);
					break;
				case 1:
					SetBit(VsInputButtons::VsButtons::InsertCoin2);
					break;
				case 2:
					SetBit(VsInputButtons::VsButtons::InsertCoin3);
					break;
				case 3:
					SetBit(VsInputButtons::VsButtons::InsertCoin4);
					break;
			}
		}
	}
		...
		if (type == ConsoleNotificationType::ExecuteShortcut) {
			...
			switch (params->Shortcut) {
				...
				case EmulatorShortcut::VsServiceButton:
					SetServiceButtonState(0, true);
					break;
				case EmulatorShortcut::VsServiceButton2:
					SetServiceButtonState(1, true);
					break;
			}
			...
			switch (params->Shortcut) {
				default:
					break;
				case EmulatorShortcut::VsServiceButton:
					SetServiceButtonState(0, false);
					break;
				case EmulatorShortcut::VsServiceButton2:
					SetServiceButtonState(1, false);
					break;
			}
		}
	}
